...
J1=1.3999;% densidade de corrente (A/mm2) - tabela 8.3 - pag 348 ok
J2=1.4004;% densidade de corrente (A/mm2) - tabela 8.3 - pag 348 ok
Bm=1.5999;% pag 348 ok
Ksw=6.9638;% Fator de espaço  pag 347 ok
%kt=0.45;
kt=0.5464 %tabela 8.4 pag 350 ok
Rjan=3.4556; %ítem 8.12 pag 353 ok
rel=1.1273;%ítem 8.12 pag 353 ok
