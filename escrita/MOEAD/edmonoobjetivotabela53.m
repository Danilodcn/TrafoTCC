...
% 
%[1,20000000000000 1,40000000000000 1,54802788055499 6,96678496595354 0,475599903675546 3,46025076651683 1,14496996304006]

J1=1.20;% densidade de corrente (A/mm2) - tabela 8.3 - pag 348 ok
J2=1.40;% densidade de corrente (A/mm2) - tabela 8.3 - pag 348 ok
Bm=1.50
0;% pag 348 ok
Ksw=7.0;% Fator de espaço  pag 347 ok
%kt=0.45;
kt=0.55 %tabela 8.4 pag 350 ok
Rjan=3.40; %ítem 8.12 pag 353 ok
rel=1.20;%ítem 8.12 pag 353 ok
